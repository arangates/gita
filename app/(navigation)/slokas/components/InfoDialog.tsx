      ...
      <DialogContent size="large">
        <div className="flex gap-8">
          <div className="flex flex-col gap-3 flex-1 text-[13px] text-gray-11 leading-relaxed">
            ...
            <p>
              Prompt Explorer is a tool to easily browse, share, and add presets to{" "}
              <a href="https://raycast.com">Raycast</a>.
            </p>
            <p>
              Select the slokas by clicking on them. To select multiple, hold <Kbd>⌘</Kbd> or select them with your
              mouse.
            </p>
            <p>
              Then, click the “Add to Raycast” button to import these slokas as AI Commands. You can also download the
              slokas as a JSON file, or copy the URL to share with others.
            </p>
